...
namespace DR.Dto
{
	...
	internal class GeneratedMessagePackResolver : MsgPack::IFormatterResolver
	{
		...
		public static readonly MsgPack::IFormatterResolver InstanceWithStandardResolver = MsgPack::Resolvers.CompositeResolver.Create(Instance, MsgPack::Resolvers.StandardResolver.Instance);
	...
	internal static class GeneratedMessagePackResolverGetFormatterHelper
	{
		...
		internal static object GetFormatter(global::System.Type t)
		{
			...
			switch (key)
			{
				case 0: return new Formatters::DR.Dto.DemoPingRequestDtoFormatter();
				case 1: return new Formatters::DR.Dto.DemoPingResponseDtoFormatter();
				default: return null;
			}
		}
	}
